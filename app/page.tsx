export const metadata = {
  ...
  description: 'Shop every season',
}

export default function Home() {
  const pages = [
    { href: '/landing', emoji: '🏠', label: 'Landing Page', desc: 'Marketing page · 5 languages' },
    { href: '/store', emoji: '🛍️', label: 'Store', desc: 'Browse, cart, checkout' },
    { href: '/loyalty', emoji: '🪙', label: 'Loyalty Program', desc: 'Points, tiers, rewards' },
    { href: '/payment', emoji: '💳', label: 'Payment Methods', desc: 'Stripe, PromptPay, KBZPay' },
    ...
    <main style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '3rem', maxWidth: '900px', margin: '0 auto 3rem' }}>
        ...
        <p style={{
          ...
          opacity: 0.7,
          margin: 0
        }}>Tap any page below to view it</p>
      </div>
